...
pub struct PointerScanParameters {
    ...
    pointer_data_type_ref: DataTypeRef,
    offset_size: u64,
    max_depth: u64,
    scan_statics: bool,
    scan_heaps: bool,
...
impl PointerScanParameters {
    ...
    pub fn get_pointer_data_type_ref(&self) -> &DataTypeRef {
        &self.pointer_data_type_ref
    }
    ...
    pub fn get_scan_statics(&self) -> bool {
        self.scan_statics
    }

    pub fn get_scan_heaps(&self) -> bool {
        self.scan_heaps
    }
